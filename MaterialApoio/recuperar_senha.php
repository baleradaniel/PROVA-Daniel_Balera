...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($usuario) {
        ...
        echo "<script>alert('Uma senha temporaria foi enviada para o seu email (simulação). Verifique o arquivo emails_simulads.txt'); window.location.href = 'login.php';</script>";
